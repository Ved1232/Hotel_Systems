...
class Hotel:
    def __init__(self, root):
        ...
        # display message
        self.label = Label(top, font=('arial', 50, 'bold'), text="WELCOME", fg="#AAD9BB", anchor="center")
        self.label.grid(row=0, column=3)

        # create check in button
        self.check_in_button = Button(bottom, text="CHECK IN", font=('', 20), bg="#F9F7C9", relief=RIDGE, height=2,
                                      width=50,
        ...
        self.check_out_button = Button(bottom, text="CHECK OUT", font=('', 20), bg="#F9F7C9", relief=RIDGE, height=2,
        ...
        self.room_info_button = Button(bottom, text="INFORMATION OF ROOMS", font=('', 20), bg="#F9F7C9", relief=RIDGE,
                                       height=2,
                                       width=50, fg="black", anchor="center",
        ...
        self.get_info_button = Button(bottom, text="INFORMATION OF ALL GUEST", font=('', 20), bg="#F9F7C9",
                                      relief=RIDGE,
        ...
        self.exit_button = Button(bottom, text="EXIT", font=('', 20), bg="#F9F7C9", relief=RIDGE, height=2, width=50,
                                  fg="black",
